...
import { z } from "zod";
import { BillingPlan, MembershipRole, MembershipStatus, OrganizationKind } from "@prisma/client";
...
export async function POST(req: Request) {
  ...
  if (exists) return jsonError("Ese email ya está registrado. Iniciá sesión o usá otro.", 409);
